...
export default async function HomePage() {
	...
	return <main>
	<section className="market-hero"><div className="container market-hero-inner"><div><p className="eyebrow">Welcome to ManaStore</p><h1>Good products.<br /><em>Easy shopping.</em></h1><p className="sans">Explore everyday fashion today, with more useful categories joining soon.</p><Button href="/products">Start shopping</Button></div><div className="hero-offer sans"><strong>Fresh picks</strong><span>Up to 30% off</span><small>On selected fashion styles</small></div></div></section>
